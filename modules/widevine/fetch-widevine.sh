...
_WV_CANDIDATES=(
    # Commit-pinned prebuilt repo (x86_64 Android 11 / Widevine L3)
    "https://github.com/supremegamers/vendor_google_proprietary_widevine-prebuilt/archive/48d1076a570837be6cdce8252d5d143363e37cc1.tar.gz"
)
...
_extract_widevine() {
    ...
    for so in \
        "prebuilts/lib64/libwvhidl.so" \
        "prebuilts/lib64/mediadrm/libwvdrmengine.so"; do
    ...
    local manifest_src="${extract_dir}/prebuilts/etc/vintf/manifest/manifest_android.hardware.drm@1.3-service.widevine.xml"
